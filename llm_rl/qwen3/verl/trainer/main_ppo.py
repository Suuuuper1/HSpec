...
def run_ppo(config) -> None:
    ...
    if config.actor_rollout_ref.rollout.get("use_hspec_decode", False):
        ...
        print(
            ...
            f"proposer_cache_max_prompts={os.getenv('HSPEC_PROPOSER_CACHE_MAX_PROMPTS', '512')}, "
            f"proposer_cache_max_cpu_bytes={os.getenv('HSPEC_PROPOSER_CACHE_MAX_CPU_BYTES', '0')}, "
            f"proposer_cache_max_npu_bytes={os.getenv('HSPEC_PROPOSER_CACHE_MAX_NPU_BYTES', '0')}, "
            f"proposer_cache_max_entries={os.getenv('HSPEC_PROPOSER_CACHE_MAX_ENTRIES', '0')}, "
            f"max_ready_prefetch_materialize={os.getenv('HSPEC_MAX_READY_PREFETCH_MATERIALIZE', '0')}, "
            f"max_ready_prefetch_bytes={os.getenv('HSPEC_MAX_READY_PREFETCH_BYTES', '0')}, "
            f"proposer_batch_cache_prebuild={os.getenv('HSPEC_PROPOSER_BATCH_CACHE_PREBUILD', '1')}, "
            f"allow_hot_batch_cache_build={os.getenv('HSPEC_ALLOW_HOT_BATCH_CACHE_BUILD', '0')}, "
            f"proposer_batch_cache_max_npu_bytes={os.getenv('HSPEC_PROPOSER_BATCH_CACHE_MAX_NPU_BYTES', '0')}, "
            f"proposer_prefix_cache={os.getenv('HSPEC_PROPOSER_PREFIX_CACHE', '0')}, "
            f"proposer_store_per_prompt_npu={os.getenv('HSPEC_PROPOSER_STORE_PER_PROMPT_NPU', '0')}, "
            f"proposer_keys_cpu_dtype={os.getenv('HSPEC_PROPOSER_KEYS_CPU_DTYPE', 'table')}, "
            f"proposer_keys_device_dtype={os.getenv('HSPEC_PROPOSER_KEYS_DEVICE_DTYPE', 'float32')}, "
